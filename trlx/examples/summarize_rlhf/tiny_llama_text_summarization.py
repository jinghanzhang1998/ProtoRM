...
import trlx.trlx.trlx as trlx
from trlx.trlx.data.configs import (
    ModelConfig,
    OptimizerConfig,
    SchedulerConfig,
    TokenizerConfig,
...
if not os.path.exists(REWARD_CHECKPOINT_PATH):
    ...
    os.system(
        ...
        https://hf-mirror.com/CarperAI/openai_summarize_tldr_rm_checkpoint/resolve/main/pytorch_model.bin"
    )
# 使用tiny_llama模型
SFT_MODEL_PATH = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
